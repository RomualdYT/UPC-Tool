...
const AdminCasesManager = ({ onCaseUpdate }) => {
  const {
    allCases,
    loading,
    updateCase,
  ...
  return (
    <div className="space-y-6">
      {/* Titre */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Gestion des commentaires et apports juridiques</h1>
        <p className="text-gray-600">Ajoutez des résumés et identifiez les apports juridiques dans les décisions UPC</p>
      </div>

      <div className="flex h-[calc(100vh-300px)]">
        {/* Sidebar */}
        <div className="w-80 border-r border-gray-200 pr-6 overflow-y-auto bg-gray-50 rounded-lg p-4">
          <div className="space-y-6">
            {/* Search */}
            <div>
...
export default AdminCasesManager;